...
public class GetTweets {
	...
	public void getTweet(){
		...
		configBuilder.setOAuthConsumerKey("<consumerKey>");			//key removed
		configBuilder.setOAuthConsumerSecret("<consumerSecret>");	//secret removed
		configBuilder.setOAuthAccessToken("<accessToken>");			//accessToken removed
		configBuilder.setOAuthAccessTokenSecret("<accessTokenSecret>");		//token secret removed
